...
export class RoleList extends Component {
  ...
  openAddRoleModal = () => {
    this.setState({ isAddRoleModalVisible: true });
  };
  ...
  render() {
    const { users, userProfileVisible, selectedUser, isAddRoleModalVisible } = this.state;
    ...
    return (
      <Card bodyStyle={{ padding: '-3px' }}>
        <Flex alignItems="center" justifyContent="space-between" mobileFlex={false}>
          ...
          <Flex gap="7px">
            <Button type="primary" className="ml-2" onClick={this.openAddRoleModal}>
              <PlusOutlined />
              <span>New</span>
            </Button>
        ...
        <Modal
          ...
          className='mt-[-70px]'
        >
          <AddRole onClose={this.closeAddRoleModal} />
        </Modal>
      </Card>
    );
  }
