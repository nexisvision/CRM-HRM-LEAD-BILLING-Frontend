            ...
            {({ values, setFieldValue, setFieldTouched, handleSubmit }) => (
              ...
              >
                <Row gutter={16}>
                  ...
                  <Col span={12}>
                    <div className="form-item">
                      <label className="font-semibold mb-2">job Application</label>
                  ...
                  <Col span={12}>
                    <div className="form-item">
                      ...
                      <Field name="offerexpireon" as={Input} placeholder="Enter Offer Expire On" />
                      <ErrorMessage
                        name="offerexpireon"
                        component="div"
                        className="error-message text-red-500 my-1"
                  ...
                  <Col span={12}>
                    <div className="form-item">
                      ...
                      <Field name="expectedjoiningdate" as={Input} placeholder="Enter Expected Joining Date" />
                      <ErrorMessage
