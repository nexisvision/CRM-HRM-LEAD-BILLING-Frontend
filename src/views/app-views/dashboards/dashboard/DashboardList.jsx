        ...
        <div className="p-2 bg-gray-50">
            ...
            <Row gutter={[24, 32]}>
                ...
                <Col xs={24} sm={24} md={16} lg={16} xl={16}>
                    <div className="bg-white rounded-lg shadow p-6 h-full flex flex-col" style={{height: '450px'}} >
            ...
            <div className="container p-4 bg-white  rounded-lg shadow mt-8">
                <h1 className="text-xl font-medium  text-black">Recent Users Registration</h1>
                <RegistionTable />
            </div>
        </div>
    );
