        ...
        <div className="sm:w-full md:w-[95%] md:mr-[30px] lg:w-[240px] md:ml-[23px] h-full mt-20 px-[30px] md:p-0 lg:p-0">
          ...
          <ul className="">
            <li
              ...
              className={`cursor-pointer p-3 flex justify-between rounded-t-lg ${selectedSection === "general" ? "bg-blue-500 text-white" : "bg-white"
                }`}
            >
              <div>
                General
            ...
            <li
              ...
              className={`cursor-pointer p-3 flex justify-between ${selectedSection === "attachment" ? "bg-blue-500 text-white" : "bg-white"
                }`}
            >
              <div>
                Attachment
            ...
            <li
              ...
              className={`cursor-pointer p-3 flex justify-between  ${selectedSection === "comment" ? "bg-blue-500 text-white" : "bg-white"
                }`}
            >
              <div>
                Comment
            ...
            <li
              ...
              className={`cursor-pointer p-3 flex justify-between rounded-b-lg ${selectedSection === "notes" ? "bg-blue-500 text-white" : "bg-white"
                }`}
            >
              <div>
                Notes
