...
const transferdata = async () => {
  ...
  try {
    const res = await axios.get("http://localhost:5353/api/v1/accounts/transfer", {
      headers: {
...
const addaccounts = async (payload) => {
  ...
  try {
    const res = await axios.post(
      "http://localhost:5353/api/v1/accounts/transfer",
      payload,
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
const transferdelte = async (id) => {
  ...
  try {
    const res = await axios.delete(
      `http://localhost:5353/api/v1/accounts/transfer/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
const edittransfer = async (idd, values) => {
  ...
  try {
    const res = await axios.put(
      `http://localhost:5353/api/v1/accounts/transfer/${idd}`,
      values,
      {
        headers: {
          Authorization: `Bearer ${token}`,
