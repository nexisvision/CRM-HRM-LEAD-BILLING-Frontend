...
import { updateInvoice, getInvoiceById } from '../../../dashboards/project/invoice/invoicereducer/InvoiceSlice';
...
const EditInvoice = ({ onClose }) => {
    ...
    const handleFinish = async (values) => {
        try {
            ...
            await dispatch(updateInvoice({ id, data: invoiceData })); // Use invoiceId here
