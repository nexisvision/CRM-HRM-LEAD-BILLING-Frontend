...
const EditDealStages = () => {
    ...
    const onSubmit = (values) => {
        ...
        navigate('/app/systemsetup/leadstages/');
    };
                                            ...
                                            <Row gutter={16}>
                                                ...
                                                <Col span={24} className='mt-2'>
                                                    <div className="form-item">
                                                        ...
                                                        <Field name="stagename" as={Input} placeholder="Enter Lead Stage Name" />
                                                        <ErrorMessage name="stagename" component="div" className="error-message text-red-500 my-1" />
                                                    </div>
                                                </Col>
                                                <Col span={24} className='mt-2'>
                                                              <div className="form-item">
