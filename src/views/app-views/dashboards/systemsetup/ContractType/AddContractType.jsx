...
const AddContractType  = () => {
    ...
    const onSubmit = (values) => {
        ...
        navigate('/app/systemsetup/contracttype/');
    };
    ...
    const validationSchema = Yup.object({
        contracttypename: Yup.string().required('Please enter contracttypename.'),
    });
                                            ...
                                            <Row gutter={16}>
                                                ...
                                                <Col span={24} className='mt-2'>
                                                    <div className="form-item">
                                                        ...
                                                        <Field name="contracttypename" as={Input} placeholder="Enter Contract Type Name" />
                                                            <ErrorMessage name="contracttypename" component="div" className="error-message text-red-500 my-1" />
                                                    </div>
                                                </Col>
