                ...
                {({ values, setFieldValue, handleSubmit, setFieldTouched, }) => (
                    <Form className="formik-form" onSubmit={handleSubmit}>
                        ...
                        <Row gutter={16}>
                            ...
                            <Col span={12} className='mt-4'>
                                <img src="https://demo.workdo.io/erpgo-saas/storage/projects/1626782532.png" className="avatar avatar-lg rounded-sm" alt="project-image" />
                            </Col>
...
//                     <Col span={12} className='hidden sm:hidden md:block lg:block'>
