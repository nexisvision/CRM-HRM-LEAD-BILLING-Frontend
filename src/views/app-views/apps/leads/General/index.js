      ...
      <Row gutter={[16, 16]}>
        <Col span={6}>
          <Card className="text-center bg-pink-100">
            <MailOutlined style={{ fontSize: '20px', color: '#ff2d55' }} />
            <div className="font-semibold mt-2 text-pink-600">Email</div>
            <div className="text-md font-bold">abc@gmail.com</div>
          </Card>
        </Col>
