...
const ClientList = () => {
  ...
  }, [tabledata,matchingClients, loggedInUser]);
...
//   const fnddtaa = tabledata.SubClient.data;
//   console.log("lll",fnddtaa)y
...
//   // useEffect(() => {
//   //   if (tabledata && tabledata?.SubClient && tabledata?.SubClient?.data) {
//   //     const filteredUsers = tabledata?.SubClient?.data?.filter(
//   //       (client) => client?.created_by === loggedInUser?.username
//   //     );
//   //     setUsers(filteredUsers);
//   //   }
