...
//     endDate: new Date()
//   });
//   const [currentMonths, setCurrentMonths] = useState([new Date().getMonth(), new Date().getMonth() + 1]);
//   const [currentYears, setCurrentYears] = useState([new Date().getFullYear(), new Date().getFullYear()]);
...
//         popupRef.current.style.top = `${buttonRect.bottom + 10}px`; // Position below
//       } else {
//         popupRef.current.style.top = `${buttonRect.top - popupRect.height - 10}px`; // Position above
//       }
...
//         ref={buttonRef}
//         onClick={() => setIsOpen(!isOpen)}
//         className="flex items-center space-x-2 px-4 py-2 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
//       >
//         <svg
//           className="w-5 h-5 text-gray-500"
//           fill="none"
